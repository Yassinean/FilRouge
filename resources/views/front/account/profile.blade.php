                            ...
                            <div class="card-body  p-4">
                                ...
                                @if(Auth::user()->role == 'employee' )
                                    <div class="mb-4">
                                        ...
                                        <textarea style="resize: none" name="education" id="education" placeholder="Education"
                                                  class="form-control" value="{{ $user->education }}">
                                        </textarea>
                                    </div>
                                    <div class="mb-4">
                                        <label for="mobile" class="mb-2">Experiences</label>
                                        <textarea style="resize: none" name="experience" id="experience" placeholder="Experiences"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="file" name="cv" id="cv" class="form-control" value="{{ $user->cv }}">
                                    </div>
